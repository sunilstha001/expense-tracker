...
export const dashboardStyles = {
  // Layout styles
  container: "min-h-screen mx-auto max-w-7xl px-3 py-4 md:px-5 md:py-6 space-y-6",
  
  // Header styles
  headerContainer: "relative overflow-hidden rounded-3xl border border-slate-200/70 bg-gradient-to-br from-white via-sky-50 to-rose-50 p-5 md:p-7 shadow-[0_16px_45px_-24px_rgba(15,23,42,0.45)]",
  headerContent: "flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 mb-5",
  headerTitle: "text-3xl md:text-4xl font-bold tracking-tight text-slate-900",
  headerSubtitle: "mt-2 text-slate-600 text-sm md:text-base",
  
  // Button styles
  addButton: "inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-3 text-sm md:text-base font-semibold text-white shadow-lg shadow-slate-300 transition-all hover:-translate-y-0.5 hover:bg-slate-800",
  
  // Time frame selector styles
  timeFrameContainer: "flex justify-start lg:justify-end",
  timeFrameWrapper: "inline-flex flex-wrap gap-1 rounded-2xl border border-slate-200 bg-white/80 p-1.5 backdrop-blur",
  timeFrameButton: (isActive) => 
    `px-3 py-2 text-xs md:text-sm rounded-xl font-medium transition-all ${
      isActive 
  ...
  // Summary cards grid
  summaryGrid: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5",
  
  // Financial card styles
  balanceBadge: "bg-indigo-100 text-indigo-800 px-2 py-1 rounded-lg text-xs",
  expenseBadge: "bg-rose-100 text-rose-800 px-2 py-1 rounded-lg text-xs",
  
  // Gauge container styles
  gaugeGrid: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-5",
  
  // Pie chart container styles
  pieChartContainer: "hidden md:block rounded-2xl border border-slate-200 bg-white/90 p-5 md:p-6 shadow-[0_14px_35px_-25px_rgba(15,23,42,0.45)]",
  pieChartHeader: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4",
  pieChartTitle: "text-lg md:text-xl font-bold text-slate-900 flex items-center gap-2",
  pieChartSubtitle: "text-sm text-slate-500",
  pieChartHeight: "h-80",
  ...
  listsGrid: "grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-5",
  
  // List container styles
  listContainer: "rounded-2xl border border-slate-200 bg-white/90 p-5 md:p-6 shadow-[0_14px_35px_-25px_rgba(15,23,42,0.45)]",
  listHeader: "mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3",
  listTitle: "text-lg md:text-xl font-bold text-slate-900 flex items-center gap-2",
  listSubtitle: "text-sm font-normal text-slate-500",
  
  // Record count badges
  incomeCountBadge: "inline-flex items-center rounded-full bg-indigo-50 px-3 py-1 text-xs md:text-sm font-medium text-indigo-700",
  expenseCountBadge: "inline-flex items-center rounded-full bg-rose-50 px-3 py-1 text-xs md:text-sm font-medium text-rose-700",
  
  // Transaction item styles
  transactionList: "space-y-3",
  incomeTransactionItem: "flex items-center justify-between rounded-xl border border-indigo-100 bg-indigo-50/70 p-3 md:p-4 transition-all hover:-translate-y-0.5 hover:bg-indigo-50",
  expenseTransactionItem: "flex items-center justify-between rounded-xl border border-rose-100 bg-rose-50/70 p-3 md:p-4 transition-all hover:-translate-y-0.5 hover:bg-rose-50",
  
  // Transaction icon container
  incomeIconContainer: "p-2 bg-white rounded-lg shadow-sm",
  expenseIconContainer: "p-2 bg-white rounded-lg shadow-sm",
  ...
  incomeAmount: "font-bold text-indigo-700",
  expenseAmount: "font-bold text-rose-700",
  ...
  viewAllButton: "w-full flex items-center justify-center gap-2 rounded-xl py-3 font-medium text-slate-700 transition-colors hover:bg-slate-100",
  
  // Icon container styles
  iconContainer: (color) => `p-2 ${color} rounded-lg`,
  
  // Specific icon colors
  walletIconContainer: "p-2 bg-indigo-100 rounded-lg",
  arrowDownIconContainer: "p-2 bg-rose-100 rounded-lg",
  piggyBankIconContainer: "p-2 bg-sky-100 rounded-lg",
};
...
export const trendStyles = {
  ...
  positiveRate: "bg-sky-100 text-sky-700",
...
export const incomeStyles = {
  // Layout
  wrapper: "max-w-7xl mx-auto space-y-5 px-3 py-4 md:px-5 md:py-6",
  headerContainer: "relative overflow-hidden rounded-3xl border border-slate-200/70 bg-gradient-to-br from-white via-indigo-50 to-cyan-50 p-5 md:p-7 shadow-[0_16px_45px_-24px_rgba(15,23,42,0.45)]",
  header: "flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-5",
  headerTitle: "text-2xl md:text-3xl font-bold tracking-tight text-slate-900",
  headerSubtitle: "mt-1 text-sm md:text-base text-slate-600",
  addButton: "inline-flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm md:text-base font-semibold text-white shadow-lg shadow-slate-300 transition-all hover:-translate-y-0.5 hover:bg-slate-800",
  
  // Summary Cards
  summaryGrid: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4",
  
  // Chart
  chartContainer: "hidden md:block rounded-2xl border border-slate-200 bg-white/90 p-5 md:p-6 shadow-[0_14px_35px_-25px_rgba(15,23,42,0.45)]",
  chartTitle: "text-lg md:text-xl font-bold text-gray-800 mb-4 md:mb-5 flex items-center gap-2 md:gap-3",
  
  // Transaction List
  listContainer: "relative overflow-hidden rounded-2xl border border-slate-200 bg-white/90 p-4 md:p-6 shadow-[0_14px_35px_-25px_rgba(15,23,42,0.45)]",
  listHeader: "mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3",
  sectionTitle: "text-lg md:text-xl font-bold text-gray-800 mb-4 md:mb-5 flex items-center gap-2 md:gap-3",
  
  // Filter Section
  filterContainer: "flex w-full flex-col gap-2 sm:w-auto sm:flex-row",
  filterSelect: "w-full appearance-none rounded-xl border border-slate-300 bg-white px-3 py-2.5 pr-8 text-sm text-slate-700 focus:border-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-100",
  exportButton: "inline-flex w-full sm:w-auto items-center justify-center gap-1 rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-700 transition-all hover:-translate-y-0.5 hover:bg-slate-50",
  
  // Transaction Items
  transactionList: "space-y-3 -mx-2 md:mx-0",
  viewAllButton: "mt-4 flex w-full items-center justify-center gap-2 rounded-xl py-3 text-center font-medium text-slate-700 transition-colors hover:bg-slate-100",
  
  // Empty State
  emptyStateContainer: "text-center py-6 md:py-8",
  emptyStateIcon: "w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-full bg-indigo-50 flex items-center justify-center",
  ...
  emptyStateButton: "mt-3 md:mt-4 flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-sky-500 hover:from-indigo-600 hover:to-sky-600 text-white px-3 py-2 md:px-4 md:py-2.5 rounded-lg md:rounded-xl transition-all shadow-md hover:shadow-lg mx-auto text-sm md:text-base",
  
  // Time Frame Selector Container
  timeFrameContainer: "flex justify-start lg:justify-end",

   // Chart header container 
  chartHeaderContainer: "mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between",
  ...
  iconGreen: "p-2 bg-indigo-100 rounded-lg",
  iconBlue: "p-2 bg-cyan-100 rounded-lg",
  iconPurple: "p-2 bg-sky-100 rounded-lg",
  
  // Icon text colors 
  textGreen: "text-indigo-700",
  textBlue: "text-cyan-700",
  textPurple: "text-sky-700",
  ...
  borderGreen: "border-l-4 border-indigo-500",
  borderBlue: "border-l-4 border-cyan-500",
  borderPurple: "border-l-4 border-sky-500",
};

export const expensePageStyles = {
  // Main container
  container: "max-w-7xl mx-auto space-y-5 px-3 py-4 md:px-5 md:py-6",
  
  // Header card
  headerCard: "relative overflow-hidden rounded-3xl border border-slate-200/70 bg-gradient-to-br from-white via-orange-50 to-rose-50 p-5 md:p-7 shadow-[0_16px_45px_-24px_rgba(15,23,42,0.45)]",
  headerContainer: "mb-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between",
  headerTitle: "text-2xl md:text-3xl font-bold tracking-tight text-slate-900",
  headerSubtitle: "mt-1 text-sm md:text-base text-slate-600",
  addButton: "inline-flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-sm md:text-base font-semibold text-white shadow-lg shadow-slate-300 transition-all hover:-translate-y-0.5 hover:bg-slate-800",
  
  // Financial cards grid
  cardsGrid: "grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3",
  
  // Chart container
  chartContainer: "hidden md:block rounded-2xl border border-slate-200 bg-white/90 p-5 md:p-6 shadow-[0_14px_35px_-25px_rgba(15,23,42,0.45)]",
  chartHeader: "mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between",
  chartTitle: "flex items-center gap-2 text-lg md:text-xl font-bold text-slate-900",
  ...
  transactionsContainer: "relative overflow-hidden rounded-2xl border border-slate-200 bg-white/90 p-5 md:p-6 shadow-[0_14px_35px_-25px_rgba(15,23,42,0.45)]",
  transactionsHeader: "mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between",
  transactionsTitle: "flex items-center gap-2 text-lg md:text-xl font-bold text-slate-900",
  filterSelect: "w-full appearance-none rounded-xl border border-slate-300 bg-white px-3 py-2.5 pr-8 text-sm text-slate-700 focus:border-rose-400 focus:outline-none focus:ring-2 focus:ring-rose-100",
  ...
  // Icons
  iconOrange: "p-2 bg-rose-100 rounded-lg",
  iconAmber: "p-2 bg-orange-100 rounded-lg",
  iconYellow: "p-2 bg-amber-100 rounded-lg",
  textOrange: "text-rose-700",
  textAmber: "text-orange-700",
  textYellow: "text-amber-700",
  
  // Borders
  borderOrange: "border-l-4 border-rose-500",
  borderAmber: "border-l-4 border-orange-500",
  borderYellow: "border-l-4 border-amber-500",
  // Chart tooltip styles 
  tooltipContent: {
    backgroundColor: "rgba(255, 255, 255, 0.95)",
    border: "1px solid #e5e7eb",
  ...
  chartExportButton: "flex items-center gap-1 bg-white border border-slate-300 hover:bg-slate-50 text-gray-700 px-4 py-2 rounded-lg transition-all text-sm hover:shadow-md",
  
  // Additional empty state style 
  emptyStateSubtext: "text-sm text-gray-500 mt-2",
  
  // Timeframe positioning 
  timeframePositioning: "flex justify-start lg:justify-end",
  
  // Transaction item specific styles 
  transactionItemContainer: "group mb-3 flex cursor-pointer items-center justify-between rounded-xl border border-slate-200 p-3 transition-all duration-300 hover:-translate-y-0.5 hover:bg-rose-50/60",
...
export const profileStyles = {
  ...
  // Header styles
  header: "bg-gradient-to-r from-indigo-500 to-sky-600 p-8 text-center",
  ...
  userEmail: "text-indigo-100 mt-2",
  ...
  icon: "w-5 h-5 mr-2 text-indigo-600",
  
  // Form styles
  label: "text-sm text-gray-500  block mb-1",
  input: "w-full px-4 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-300 focus:border-indigo-500",
  inputWithError: "w-full px-4 py-2 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-indigo-300 focus:border-indigo-500",
  
  // Button styles
  buttonPrimary: "flex-1 bg-gradient-to-r from-indigo-500 to-sky-600 text-white py-2.5 rounded-xl font-medium shadow-md",
  buttonSecondary: "flex-1 py-2.5 border border-gray-300 text-gray-700 rounded-xl font-medium hover:bg-gray-100",
  editButton: "text-indigo-600 hover:text-indigo-700 font-medium text-sm",
  changeButton: "text-indigo-600 hover:text-indigo-700 font-medium lg:text-sm",
...
export const loginStyles = {
  // Page container
  pageContainer: "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-indigo-50 to-sky-50",
  
  // Card container
  cardContainer: "w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden",
  
  // Header styles
  header: "bg-gradient-to-r from-indigo-500 to-sky-600 p-6 text-center",
  ...
  // Button
  button: "w-full bg-gradient-to-r from-indigo-500 to-sky-600 text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-center",
...
export const navbarStyles = {
  ...
  userAvatar: "w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-br from-indigo-600 to-sky-500 text-white font-bold text-lg",
  statusIndicator: "absolute -bottom-1 -right-1 w-3 h-3 bg-sky-500 rounded-full border-2 border-white",
  ...
  dropdownAvatar: "w-10 h-10 rounded-full bg-gradient-to-br from-indigo-600 to-sky-500 flex items-center justify-center text-white font-bold text-lg",
...
export const signupStyles = {
  ...
  header: "bg-gradient-to-r from-indigo-500 to-sky-600 p-6 text-center relative",
  avatar: "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4",
  headerTitle: "text-2xl font-bold text-white",
  headerSubtitle: "text-indigo-100 mt-2",
  ...
  inputContainer: "relative",
  inputIcon: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400",
  input: "w-full pl-10 pr-4 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-indigo-300 focus:border-indigo-500",
  passwordInput: "w-full pl-10 pr-10 py-3 bg-gray-50 border rounded-xl focus:ring-2 focus:ring-indigo-300 focus:border-indigo-500",
  passwordToggle: "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600",
  ...
  signInLink: "font-medium text-indigo-600 hover:underline",
...
export const sidebarStyles = {
  ...
  userInitials: {
    base: "w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-400 to-sky-500 flex items-center justify-center text-white font-bold text-xl"
  },
  ...
  menuItem: {
    ...
    inactive: "text-gray-600 hover:text-indigo-700 hover:bg-gray-50",
  ...
  activeIndicator: "absolute right-4 w-2 h-2 bg-indigo-400 rounded-full animate-ping",
  
  // Toggle button
  toggleButton: {
    base: "absolute -right-3 top-12 z-20 w-6 h-6 bg-white border border-gray-300 rounded-full flex items-center justify-center text-gray-500 hover:text-indigo-600 hover:border-indigo-400 hover:bg-indigo-50 transition-all"
  },
  ...
  footerLink: {
    base: "flex items-center gap-3 py-2 rounded-xl font-medium text-gray-600 hover:text-indigo-700 hover:bg-gray-50",
  ...
  mobileFooterLink: "flex items-center gap-4 py-2 font-medium text-gray-600 hover:text-indigo-700",
  mobileLogoutButton: "flex items-center gap-4 py-2 font-medium text-gray-600 hover:text-red-600 w-full",
  
  // Mobile menu button
  mobileMenuButton: "lg:hidden fixed bottom-6 right-6 z-50 w-14 h-14 bg-gradient-to-br from-indigo-500 to-sky-600 text-white rounded-full flex items-center justify-center shadow-xl"
};
...
export const styles = {
  ...
  transactions: {
    ...
    iconWrapper: (type) => type === 'income' ? 'bg-indigo-100 text-indigo-600' : 'bg-orange-100 text-orange-600',
    icon: "w-4 h-4",
    details: "min-w-0",
    description: "font-medium text-gray-800 truncate max-w-[120px]",
    meta: "text-xs text-gray-500 mt-1",
    amount: (type) => `font-semibold ${type === 'income' ? 'text-indigo-600' : 'text-orange-600'}`,
    emptyState: "text-center py-8",
    ...
    emptyText: "text-gray-600 font-medium",
    viewAllContainer: "pt-4 border-t border-gray-100",
    viewAllButton: "w-full flex items-center justify-center gap-2 py-3 text-indigo-600 font-medium hover:bg-indigo-50 rounded-xl transition-colors",
  },
  ...
  categories: {
    ...
    summaryIncomeCard: "bg-gradient-to-br from-indigo-50 to-sky-50 rounded-xl p-4",
  ...
  colors: {
    transaction: {
      text: (type) => type === 'income' ? 'text-indigo-600' : 'text-orange-600',
      bg: (type) => type === 'income' ? 'bg-indigo-100 text-indigo-600' : 'bg-orange-100 text-orange-600',
    },
    expenseChange: (change) => change > 0 ? 'text-orange-600' : 'text-sky-600',
  },
};