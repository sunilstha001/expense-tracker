    ...
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.summaryGrid}>
        <FinancialCard
          ...
          label="Total Balance"
          value={`Rs. ${Math.round(displayIncome - displayExpenses).toLocaleString()}`}
          additionalContent={
        ...
        <FinancialCard
          icon={
            <div className={dashboardStyles.piggyBankIconContainer}>
              <PiggyBank className=" w-5 h-5 text-sky-700" />
            </div>
          }
      ...
      <div className={dashboardStyles.listsGrid}>
        ...
        <div className={dashboardStyles.listContainer}>
          <div className={dashboardStyles.listHeader}>
            <h3 className={dashboardStyles.listTitle}>
              <ProfitIcon className="w-6 h-6 text-indigo-500" /> Recent Income{" "}
              <span className={dashboardStyles.listSubtitle}>
                {" "}
                ({timeFrameRange.label})
              </span>
          ...
          <div className={dashboardStyles.transactionList}>
            ...
            {incomeListForDisplay.length === 0 && (
              <div className={dashboardStyles.emptyState}>
                <div
                  className={dashboardStyles.emptyIconContainer("bg-indigo-50")}
                >
        ...
        <div className={dashboardStyles.listContainer}>
          <div className={dashboardStyles.listHeader}>
            <h3 className={dashboardStyles.listTitle}>
              <ArrowDown className="w-6 h-6 text-rose-500" /> Recent Expenses{" "}
              <span className={dashboardStyles.listSubtitle}>
                {" "}
                ({timeFrameRange.label})
              </span>
          ...
          <div className={dashboardStyles.transactionList}>
            ...
            {expenseListForDisplay.length === 0 && (
              <div className={dashboardStyles.emptyState}>
                <div
                  className={dashboardStyles.emptyIconContainer("bg-rose-50")}
                >
